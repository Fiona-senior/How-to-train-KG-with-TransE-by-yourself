...
class TransE:
    ...
    # file1 = entity_50dim ; file2 = relation_50dim ; file3 = test.txt
...
if __name__ == '__main__':
    ...
    file1 = "VC/train.txt"  # 就是把train.txt的尾实体和关系换个了位置，保证头实体、关系、尾实体的位置
    file2 = "VC/entity2id.txt"
    file3 = "VC/relation2id.txt"
    file4 = "VC/valid.txt"

    file5 = "vc_res/entity_50dim_batch400"
    file6 = "vc_res/relation_50dim_batch400"
